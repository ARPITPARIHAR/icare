...
<html class="no-js" lang="zxx">
    <head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="assets/img/favicon.ico"><body>
    <!-- Preloader Start -->
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets/img/logo/icare_logo.png" alt="">
                </div>
            </div>
        </div> --}}
    </div>
    ...
    <header>
        <!-- Header Start -->
       <div class="header-area header-transparent" style="background-color:#121643;height:100px;">
                        ...
                        <div class="row align-items-center">
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav> 
                                        <ul id="navigation">                                                                                                                                     
                                            ...
                                            <li class=""style="font-family: cursive; font-size: 24px;"><a href="services.html">Services</a></li>
                                      
                                                {{-- <ul class="submenu">
                                                    <li class="bg-red-500"><a href="blog.html">Blog</a></li>
                                                    <li class="bg-red-500"><a href="blog_details.html">Blog Details</a></li>
                                                </ul>
                                            </li>
                                            <li class="bg-red-500"><a href="#">Pages</a>
                                                <ul class="submenu">
                                                    <li class="bg-red-500"><a href="elements.html">Element</a></li>
                                                </ul>
                                            </li> --}}
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-3">
                                <div class="header-right-btn f-right d-none d-lg-block">
                                    <a href="#" class="btn header-btn" style="background-color: #eb566c";>
                                        <!-- iocn -->
